    ...
    return (
        <section className='love-us-section'>
            ...
            <div className='love-us-card-container'>
                <motion.div initial={{ opacity: 0, scale: 0 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ margin: '-100px', once: false }} className='love-us-card'>
                ...
                <motion.div initial={{ opacity: 0, scale: 0 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ margin: '-140px', once: false }} className='love-us-card'>
                ...
                <motion.div initial={{ opacity: 0, scale: 0 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ margin: '-180px', once: false }} className='love-us-card'>
